...
public class Supplier implements Serializable {
    ...
    public Boolean getInnerSupplier() {
        return innerSupplier;
    }

    public void setInnerSupplier(Boolean innerSupplier) {
    ...
    public String getRegCapitalCurrencyId() {
        return regCapitalCurrencyId;
    }

    public void setRegCapitalCurrencyId(String regCapitalCurrencyId) {
        this.regCapitalCurrencyId = regCapitalCurrencyId;
    }
    ...
    public Boolean getCarriers() {
        return carriers;
    }

    public void setCarriers(Boolean carriers) {
    ...
    public String toString() {
        ...
        sb.append(", supplierBusinessId=").append(supplierBusinessId);
