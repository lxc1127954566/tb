...
public class CustomerAddress implements Serializable {
    ...
    private Boolean mainOrderAddr;

    private Boolean mainShipToAddr;

    private Boolean mainInvoiceAddr;

    private Boolean mainPayAddr;
    ...
    public Boolean getMainOrderAddr() {
        return mainOrderAddr;
    }

    public void setMainOrderAddr(Boolean mainOrderAddr) {
        this.mainOrderAddr = mainOrderAddr;
    }

    public Boolean getMainShipToAddr() {
        return mainShipToAddr;
    }

    public void setMainShipToAddr(Boolean mainShipToAddr) {
        this.mainShipToAddr = mainShipToAddr;
    }

    public Boolean getMainInvoiceAddr() {
        return mainInvoiceAddr;
    }

    public void setMainInvoiceAddr(Boolean mainInvoiceAddr) {
        this.mainInvoiceAddr = mainInvoiceAddr;
    }

    public Boolean getMainPayAddr() {
        return mainPayAddr;
    }

    public void setMainPayAddr(Boolean mainPayAddr) {
        this.mainPayAddr = mainPayAddr;
    }
    ...
    public String toString() {
        ...
        sb.append(", mainOrderAddr=").append(mainOrderAddr);
        sb.append(", mainShipToAddr=").append(mainShipToAddr);
        sb.append(", mainInvoiceAddr=").append(mainInvoiceAddr);
        sb.append(", mainPayAddr=").append(mainPayAddr);
