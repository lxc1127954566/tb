...
public class CustomerProperty implements Serializable {
    ...
    private String orgIdRtk;

    private String orgIdRoid;
    ...
    public String getBpPropertyId() {
        return bpPropertyId;
    }

    public void setBpPropertyId(String bpPropertyId) {
        this.bpPropertyId = bpPropertyId;
    }
    ...
    public String getOrgIdRtk() {
        return orgIdRtk;
    }

    public void setOrgIdRtk(String orgIdRtk) {
        this.orgIdRtk = orgIdRtk;
    }

    public String getOrgIdRoid() {
        return orgIdRoid;
    }

    public void setOrgIdRoid(String orgIdRoid) {
        this.orgIdRoid = orgIdRoid;
    }
    ...
    public String toString() {
        ...
        sb.append(", customerPropertyId=").append(customerPropertyId);
        sb.append(", propertyValue=").append(propertyValue);
        sb.append(", remark=").append(remark);
        sb.append(", bpPropertyId=").append(bpPropertyId);
        sb.append(", parentCustomerId=").append(parentCustomerId);
        sb.append(", propertyValueId=").append(propertyValueId);
        sb.append(", propertyValueDesc=").append(propertyValueDesc);
        ...
        sb.append(", orgIdRtk=").append(orgIdRtk);
        sb.append(", orgIdRoid=").append(orgIdRoid);
