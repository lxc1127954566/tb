...
public class FeatureGroup implements Serializable {
    ...
    public String getFeatureForm() {
        return featureForm;
    }

    public void setFeatureForm(String featureForm) {
    ...
    public String getParentFeatureGroupId() {
        return parentFeatureGroupId;
    }

    public void setParentFeatureGroupId(String parentFeatureGroupId) {
        this.parentFeatureGroupId = parentFeatureGroupId;
    }
    ...
    public String toString() {
        ...
        sb.append(", featureGroupCode=").append(featureGroupCode);
        sb.append(", featureGroupName=").append(featureGroupName);
        sb.append(", itemFeatureControl=").append(itemFeatureControl);
        sb.append(", remark=").append(remark);
        sb.append(", businessRange=").append(businessRange);
        sb.append(", itemFormat=").append(itemFormat);
        sb.append(", itemForm=").append(itemForm);
        sb.append(", featureFormat=").append(featureFormat);
        sb.append(", featureForm=").append(featureForm);
        sb.append(", featureGenerateMode=").append(featureGenerateMode);
        sb.append(", parentFeatureGroupId=").append(parentFeatureGroupId);
