...
public class SalesCenter implements Serializable {
    ...
    public String getSalesCenterCode() {
        return salesCenterCode;
    }

    public void setSalesCenterCode(String salesCenterCode) {
        this.salesCenterCode = salesCenterCode;
    }
    ...
    public String toString() {
        ...
        sb.append(", salesCenterId=").append(salesCenterId);
        sb.append(", ownerDept=").append(ownerDept);
        sb.append(", ownerEmp=").append(ownerEmp);
        sb.append(", salesCenterCode=").append(salesCenterCode);
        sb.append(", salesCenterName=").append(salesCenterName);
