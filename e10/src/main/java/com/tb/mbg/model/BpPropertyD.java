...
public class BpPropertyD implements Serializable {
    private String bpPropertyDId;
    ...
    public String getBpPropertyDId() {
        return bpPropertyDId;
    }

    public void setBpPropertyDId(String bpPropertyDId) {
        this.bpPropertyDId = bpPropertyDId;
    }
    ...
    public String toString() {
        ...
        sb.append(", bpPropertyDId=").append(bpPropertyDId);
